...
LinkedIn.prototype.onRequest = function(req, res) {
  ...
  function onToken(error, oauth_access_token, oauth_access_token_secret, results){
    ...
    oa.getProtectedResource(
      "http://api.linkedin.com/v1/people/~:(id,first-name,last-name,picture-url,industry,summary,specialties,skills,projects,headline,site-standard-profile-request)?format=json", 
      "GET", 
      oauth_access_token, 
